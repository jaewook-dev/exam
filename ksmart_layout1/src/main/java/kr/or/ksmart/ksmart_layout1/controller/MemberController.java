...
public class MemberController {
	...
	public String searchMember(@RequestParam(value="sk") String sk, @RequestParam(value="sv") String sv, Model model) {
		List<Member> list = memberService.searchMember(sk, sv) ;
		model.addAttribute("memberList", list);
		return "member/mlist/memberList";
	}
